...
PS D:\work\cfd_work\ModernCFD\codes\hybrid\mpi_openmp\04a\build> mpiexec -n 2 .\Release\testprj.exe
 nThreads = 1
 provided = 1
Hybrid: Hello from thread 0 out of 1 from process 0 out of 2 on DELL
 nThreads = 1
 provided = 1
Hybrid: Hello from thread 0 out of 1 from process 1 out of 2 on DELL
PS D:\work\cfd_work\ModernCFD\codes\hybrid\mpi_openmp\04a\build> mpiexec -n 2 .\Release\testprj.exe 2
 nThreads = 2
 provided = 1
...
PS D:\work\cfd_work\ModernCFD\codes\hybrid\mpi_openmp\04a\build> mpiexec -n 2 .\Release\testprj.exe 4
 nThreads = 4
 provided = 1
