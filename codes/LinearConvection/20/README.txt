...
PS D:\work\cfd_work\ModernCFD\codes\LinearConvection\18\build> mpiexec -n 4 .\Release\testprj.exe
FillBCPoints myzone =0 neighbor_zone_id = 1 global_face_id = 11 face_id1 = 11 face_id2 = 1 zone1 =0 zone2 =1
 ...
 InterfaceSolver::SetNeighborData
 InterfaceSolver::SetNeighborData i =0 neighbor_zone = 1 neighbor_face = 1
 InterfaceSolver::SetNeighborData this->interlist.size() =1
 SetNeighborData nSize =1
 myzoneId =0 neighbor_datas.size() = 1 --------------------
 IData::Print() zone_id =1
1
 1： this->zone_id =0 neighbor_zoneid = 1
1: idata.interface_ids[0]=1
...
FillBCPoints myzone =1 neighbor_zone_id = 2 global_face_id = 21 face_id1 = 11 face_id2 = 1 zone1 =1 zone2 =2
 ...
 InterfaceSolver::SetNeighborData
 InterfaceSolver::SetNeighborData i =0 neighbor_zone = 0 neighbor_face = 11
 InterfaceSolver::SetNeighborData i =1 neighbor_zone = 2 neighbor_face = 1
 InterfaceSolver::SetNeighborData this->interlist.size() =2
 SetNeighborData nSize =2
...
FillBCPoints myzone =3 neighbor_zone_id = 2 global_face_id = 31 face_id1 = 11 face_id2 = 1 zone1 =2 zone2 =3
 ...
 InterfaceSolver::SetNeighborData
 InterfaceSolver::SetNeighborData i =0 neighbor_zone = 2 neighbor_face = 11
 InterfaceSolver::SetNeighborData this->interlist.size() =1
 SetNeighborData nSize =1
...
FillBCPoints myzone =2 neighbor_zone_id = 3 global_face_id = 31 face_id1 = 11 face_id2 = 1 zone1 =2 zone2 =3
 ...
 InterfaceSolver::SetNeighborData
 InterfaceSolver::SetNeighborData i =0 neighbor_zone = 1 neighbor_face = 11
 InterfaceSolver::SetNeighborData i =1 neighbor_zone = 3 neighbor_face = 1
 InterfaceSolver::SetNeighborData this->interlist.size() =2
 SetNeighborData nSize =2
...
sumNode = 1.70802e+06 process id = 2 nproc = 4
 ...
 BoundaryInterface
 nIFace = 1
 ipos = 0, jpos = 0, zoneid = 0, neighbor_zone_id = 1, neighbor_face_id = 1
Average of square roots is: 0.667239
 ...
 BoundaryInterface
 nIFace = 1
 ipos = 0, jpos = 0, zoneid = 3, neighbor_zone_id = 2, neighbor_face_id = 11
PASSED
 iStep = 1, nStep = 1
 ...
 BoundaryInterface
 nIFace = 2
 ipos = 0, jpos = 0, zoneid = 1, neighbor_zone_id = 0, neighbor_face_id = 11
 ipos = 1, jpos = 0, zoneid = 1, neighbor_zone_id = 2, neighbor_face_id = 1
 iStep = 1, nStep = 1
 ...
 BoundaryInterface
 nIFace = 2
 ipos = 0, jpos = 0, zoneid = 2, neighbor_zone_id = 1, neighbor_face_id = 11
 ipos = 1, jpos = 0, zoneid = 2, neighbor_zone_id = 3, neighbor_face_id = 1