...
PS D:\work\cfd_work\ModernCFD\codes\LinearConvection\19\build> mpiexec -n 4 .\Release\testprj.exe
...
interfaceSolver->interface_bctypes.size()=0
interfaceSolver->interface_faceids.size()=0
...
sumNode = 1.70732e+06 process id = 3 nproc = 4
 iStep = 1, nStep = 1
 Boundary zoneID = 0 nBFace = 1
 ghostcell_id = 0, bc_faceid = 1, bctype = 1 x = -0.050000
 BoundaryInterface
 nIFace = 0
Average of square roots is: 0.667239
 iStep = 1, nStep = 1
 Boundary zoneID = 1 nBFace = 0
 BoundaryInterface
 nIFace = 0
 iStep = 1, nStep = 1
 Boundary zoneID = 2 nBFace = 0
 BoundaryInterface
 nIFace = 0
PASSED
 iStep = 1, nStep = 1
 Boundary zoneID = 3 nBFace = 1
