...
PS D:\work\cfd_work\ModernCFD\codes\LinearConvection\09\build> mpiexec -n 4 .\Release\testprj.exe
BoundarySolver::Init pt: zoneId = 0 nZones = 4
local pt set : 0 10
global face map :
0->1 , lc = 0<-> rc = -1 bcType = 1
10->2 , lc = 0<-> rc = 1 bcType = -1
20->2 , lc = 1<-> rc = 2 bcType = -1
30->2 , lc = 2<-> rc = 3 bcType = -1
40->1 , lc = 3<-> rc = -1 bcType = 2
