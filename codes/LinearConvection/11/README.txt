...
PS D:\work\cfd_work\ModernCFD\codes\LinearConvection\11\build> mpiexec -n 4 .\Release\testprj.exe
bcinfo......
...
global face map :
1->1 , lc = 0<-> rc = -1 bcType = 1
11->2 , lc = 0<-> rc = 1 bcType = -1
21->2 , lc = 1<-> rc = 2 bcType = -1
31->2 , lc = 2<-> rc = 3 bcType = -1
41->1 , lc = 3<-> rc = -1 bcType = 2
